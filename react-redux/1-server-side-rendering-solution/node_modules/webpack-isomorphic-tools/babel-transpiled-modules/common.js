...
exports.webpack_uses_tilde_for_node_modules = webpack_uses_tilde_for_node_modules;
...
function webpack_uses_tilde_for_node_modules(version) {
	return _semver2.default.lt(version, '3.0.0');
}

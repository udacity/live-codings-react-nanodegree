...
Webpack_isomorphic_tools_plugin.style_loader_filter = function (module, regular_expression, options, log) {
	var node_modules = options.webpackUsesTildeForNodeModules ? '~' : 'node_modules';
	...
	//
	css_loader.indexOf('/' + node_modules + '/css-loader') > 0 || css_loader.indexOf('/' + node_modules + '/.npminstall/css-loader') > 0 || css_loader.indexOf('/' + node_modules + '/.store/css-loader') > 0);
};

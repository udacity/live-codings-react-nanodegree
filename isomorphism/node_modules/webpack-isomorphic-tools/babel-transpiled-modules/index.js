...
var webpack_isomorphic_tools = function () {
	...
	(0, _createClass3.default)(webpack_isomorphic_tools, [{
		...
		key: 'webpack_uses_tilde_for_node_modules',
		value: function webpack_uses_tilde_for_node_modules() {
			var assets = this.assets();
			var version = assets.webpack && assets.webpack.version;
			...
			return (0, _common.webpack_uses_tilde_for_node_modules)(version);
		}
		...
		value: function register() {
			...
			this.loaders_hook = _requireHacker2.default.global_hook('webpack-loaders', function (required_path, module) {
				...
				parts = parts.map(function (loader) {
					...
					var node_modules = _this3.webpack_uses_tilde_for_node_modules() ? '~' : 'node_modules';
		...
		value: function excludes(path, options) {
			...
			try {
				for (var _iterator6 = (0, _getIterator3.default)(options.exclude), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
					var exclude = _step6.value;
		...
		value: function includes(path, options) {
			...
			try {
				for (var _iterator7 = (0, _getIterator3.default)(options.include), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
function construct_guesses(parts) {
	...
	try {
		for (var _iterator8 = (0, _getIterator3.default)(rest), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
			var guess = _step8.value;
